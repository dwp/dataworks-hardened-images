...
class PipelineMetadataServiceTest {
    ...
    public void shouldReturnEventuallySuccessfulItem() {
        ...
        ScanResult scanResult = mock(ScanResult.class);
        List<Map<String, AttributeValue>> items = new ArrayList<>();
        Map<String, AttributeValue> inProgressItem = tableItem(CORRELATION_ID_1, "InProgress");
    ...
    public void shouldPageForItems() {
        ...
        Map<String, AttributeValue> successfulItem1 = tableItem(CORRELATION_ID_1, "Completed");
