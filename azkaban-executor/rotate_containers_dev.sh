...
aws ecs update-service --cluster $CLUSTER --service azkaban-webserver --desired-count 0 --profile $PROFILE
...
aws ecs update-service --cluster $CLUSTER --service azkaban-executor --desired-count 1 --profile $PROFILE
retries=0
