...
aws --no-cli-pager ecs update-service --cluster $CLUSTER --service azkaban-executor --desired-count 0 --profile $PROFILE
aws --no-cli-pager ecs update-service --cluster $CLUSTER --service azkaban-webserver --force-new-deployment --desired-count 0 --profile $PROFILE
...
aws --no-cli-pager ecs update-service --cluster $CLUSTER --service azkaban-executor --task-definition $FAMILY_REVISION --desired-count 1 --profile $PROFILE
retries=0
...
aws --no-cli-pager ecs update-service --cluster $CLUSTER --service azkaban-webserver --desired-count 1 --profile $PROFILE
